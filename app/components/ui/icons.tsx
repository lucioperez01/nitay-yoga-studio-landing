...
export function BrainIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2a5 5 0 0 1 4.5 2.8A4 4 0 0 1 20 8a4 4 0 0 1-1.5 3.1A4.5 4.5 0 0 1 16 17H8a4.5 4.5 0 0 1-2.5-5.9A4 4 0 0 1 4 8a4 4 0 0 1 3.5-3.2A5 5 0 0 1 12 2Z" />
      <path d="M12 2v20" />
      <path d="M8 6h8" />
      <path d="M7 10h10" />
      <path d="M8 14h8" />
...
export function OmSymbol({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 64 64"
      ...
      {...props}
    >
      <text x="32" y="42" textAnchor="middle" fontSize="48" fontFamily="serif">
        ॐ
      </text>
    </svg>
  );
...
export function LayersIcon({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.57 3.9a2 2 0 0 0 1.66 0l8.57-3.9a1 1 0 0 0 0-1.83Z" />
...
export function LotusIcon({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 21c-2-2-5-5.5-5-10a5 5 0 0 1 10 0c0 4.5-3 8-5 10Z" />
      <path d="M12 21V9" />
      <path d="M8 14c-3-1-5.5-3-6.5-6" />
      <path d="M16 14c3-1 5.5-3 6.5-6" />
    </svg>
  );
}
